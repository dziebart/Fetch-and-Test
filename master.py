...
class Master:
    ...
    def bulk_analysis(self, analyze_list):
        ...
        # TODO: the results. The results (StatisticalResults Objects) are combined into one list and
        # TODO: then forwared to the method write_results_to_mysql, which will upload the results
        # TODO: to the MySQL Database using the "INSERT" SQL-Statements generated by the
        # TODO: StatisticalResults-Objects. 
